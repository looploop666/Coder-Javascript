    ...
    do{
            ...
            if (resultadoValidarHoras == true){
                ...
                switch (actividad.categoria) {
                    case 1:
                        actividad.registrarHsIngresadasCat1(actividad.hsIngresadas);
                        break;
                    case 2:
                        actividad.registrarHsIngresadasCat2(actividad.hsIngresadas);
                      break;
                    case 3:
                        actividad.registrarHsIngresadasCat3(actividad.hsIngresadas);
                        break;
                    case 4:
                        actividad.registrarHsIngresadasCat4(actividad.hsIngresadas);
                        break;
                    case 5:
                        actividad.registrarHsIngresadasCat5(actividad.hsIngresadas);
                        break;
                    default:
